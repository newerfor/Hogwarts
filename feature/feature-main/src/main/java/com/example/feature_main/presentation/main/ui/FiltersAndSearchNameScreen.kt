...
import com.example.feature_main.presentation.main.constant.MainLogicConstant.DEFAULT_VALUE_ANCESTRIES
import com.example.feature_main.presentation.main.constant.MainLogicConstant.DEFAULT_VALUE_HOUSE
import com.example.feature_main.presentation.main.constant.MainLogicConstant.DEFAULT_VALUE_NAME
import com.example.feature_main.presentation.main.constant.MainLogicConstant.DEFAULT_VALUE_POST
import com.example.feature_main.presentation.main.constant.MainLogicConstant.DEFAULT_VALUE_WIZARD
import com.example.feature_main.presentation.main.constant.MainLogicConstant.STAFF_LABEL
import com.example.feature_main.presentation.main.constant.MainLogicConstant.STUDENT_LABEL
import com.example.feature_main.presentation.main.constant.MainLogicConstant.WIZARD_FALSE
import com.example.feature_main.presentation.main.constant.MainLogicConstant.WIZARD_TRUE
import com.example.feature_main.presentation.main.constant.MainViewConstant.BUTTON_PADDING
import com.example.feature_main.presentation.main.constant.MainViewConstant.BUTTON_PADDING_IN_FILTER_WINDOW
import com.example.feature_main.presentation.main.constant.MainViewConstant.BUTTON_WEIGHT_IN_FILTER_WINDOW
import com.example.feature_main.presentation.main.constant.MainViewConstant.NAME_SEARCH_FONT_SIZE
import com.example.feature_main.presentation.main.constant.MainViewConstant.NAME_SEARCH_PADDING
import com.example.feature_main.presentation.main.constant.MainViewConstant.NAME_SEARCH_WEIGHT
...
fun FiltersAndSearchNameScreen(textFont: TextFont, viewModel: MainViewModel) {
    ...
    Button(
        onClick = { openWindowFilters.value = true }, colors = ButtonDefaults.buttonColors(
            containerColor = if (FiltersActivated.value) {
...
fun SearchNameScreen(name: MutableState<String>, textFont: TextFont) {
    OutlinedTextField(
        ...
        Modifier
            .fillMaxWidth(NAME_SEARCH_WEIGHT)
            .padding(NAME_SEARCH_PADDING.dp),
        ...
        Column(Modifier
            ...
            Row(modifier = Modifier.fillMaxWidth()) {
                Button(
                    ...
                    modifier = Modifier
                        .weight(BUTTON_WEIGHT_IN_FILTER_WINDOW)
                        .padding(BUTTON_PADDING_IN_FILTER_WINDOW.dp)
                ) {
